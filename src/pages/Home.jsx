            ...
            <div className='flex items-center gap-[18px] h-full'>
              <div className='font-system_ui flex items-center gap-4 text-gray-500 h-full'>
                <div className='flex flex-col items-center justify-center cursor-pointer px-2 border-b-2 border-transparent hover:border-gray-800 h-full hover:text-gray-800 duration-100'>
                  <TiHome size={25} />
                  <p className='text-[12px] hover:text-gray-800'>Home</p>
                </div>
                <div className='flex flex-col items-center justify-center cursor-pointer px-2 border-b-2 border-transparent hover:border-gray-800 h-full hover:text-gray-800 duration-100'>
                  <BsPeopleFill size={25} />
                  <p className='text-[12px] hover:text-gray-800'>My Network</p>
                </div>
                <div className='flex flex-col items-center justify-center cursor-pointer px-2 border-b-2 border-transparent hover:border-gray-800 h-full hover:text-gray-800 duration-100'>
                  <BiSolidShoppingBags size={25} />
                  <p className='text-[12px] hover:text-gray-800'>Jobs</p>
                </div>
                <div className='flex flex-col items-center justify-center cursor-pointer px-2 border-b-2 border-transparent hover:border-gray-800 h-full hover:text-gray-800 duration-100'>
                  <BiSolidMessageSquareDots size={25} />
                  <p className='text-[12px] hover:text-gray-800'>Messaging</p>
                </div>
                <div className='flex flex-col items-center justify-center cursor-pointer px-2 border-b-2 border-transparent hover:border-gray-800 h-full hover:text-gray-800 duration-100'>
                  <IoNotifications size={25} />
                  <p className='text-[12px] hover:text-gray-800'>Notifications</p>
                </div>
                <div className='flex flex-col items-center justify-center cursor-pointer px-2 border-b-2 border-transparent hover:border-gray-800 h-full hover:text-gray-800 duration-100'>
                  <FaUserCircle size={22} />
                  <div className='flex items-center'>
                    <p className='text-[12px] hover:text-gray-800'>Me</p>
                    <TiArrowSortedDown className='text-[15px] mt-1' />
                  </div>
                </div>
              </div>
              <div className='border-l border-gray-300 h-full flex items-center'>
                <div className='flex flex-col items-center justify-center text-gray-500 px-1 cursor-pointer ml-2 hover:text-gray-800 duration-100
                '>
                  <TbGridDots size={25} />
                  <div className='flex items-center '>
